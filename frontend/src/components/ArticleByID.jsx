...
function ArticleByID() {
  ...
  useEffect(() => {
    ...
    const getArticle = async () => {
      ...
      try {
        const res = await axios.get(`https://blog-app-backend-roan.vercel.app/user-api/article/${id}`, { withCredentials: true });
  ...
  const toggleArticleStatus = async () => {
    ...
    try {
      const res = await axios.patch(
        "https://blog-app-backend-roan.vercel.app/author-api/articles",
  ...
  const addComment = async (commentObj) => {
    ...
    let res = await axios.put("https://blog-app-backend-roan.vercel.app/user-api/articles", commentObj, { withCredentials: true });
    if (res.status === 200) {
